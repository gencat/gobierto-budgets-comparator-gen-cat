...
var VisBubbleLegend = Class.extend({
  init: function(divId) {
    ...
    label.append('tspan')
      .text(I18n.t('gobierto_budgets.places.show.main_budget_levels_legend_one'));

    label.append('tspan')
      .attr('x', 0)
      .attr('y', 18)
      .text(I18n.t('gobierto_budgets.places.show.main_budget_levels_legend_two'));

    svg.append('text')
      .attr('class', 'legend-label')
      .attr('x', bigScreen ? 36 : 34)
      .attr('dy', 2)
      .text(I18n.t('gobierto_budgets.places.show.main_budget_levels_legend_up'));
    ...
    svg.append('text')
      ...
      .text(I18n.t('gobierto_budgets.places.show.main_budget_levels_legend_down'));
  }
});
